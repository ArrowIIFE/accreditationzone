...
const addUserRouter = require("./router/addUserRouter");
const addPrintRouter = require("./router/printRouter");
const addEditRouter = require("./router/editRouter");
const addUpdateRouter = require("./router/updateRouter");
...
//print 
const addSinglePrintRouter = require("./router/addSinglePrintRouter")
...
const htmltopdfmarketingRouter = require("./router/htmltopdfmarketingRouter");
...
app.use("/", addPrintRouter);
app.use("/", addEditRouter);
